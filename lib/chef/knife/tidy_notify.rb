...
MESSAGE_END
      ...
      def generate_total_cookbooks_table(report_data, organization)
        return if report_data[organization]['_cookbook_count.json'].empty?
        ...
        table_body = if report_data[organization]['_cookbook_count.json']['count'] > 0
      ...
      def generate_unused_cookbooks_table(report_data, organization)
        return if report_data[organization]['_unused_cookbooks.json'].empty?
        ...
        table_body = if report_data[organization]['_unused_cookbooks.json']['count'] > 0
      ...
      def generate_node_table(report_data, organization)
        return if report_data[organization]['_stale_nodes.json'].empty?
        ...
        table_body = if report_data[organization]['_stale_nodes.json']['count'] > 0
